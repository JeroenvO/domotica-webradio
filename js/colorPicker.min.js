...
colorPicker.changed=true;}});canvas.addEventListener('mouseup',function(e){if(colorPicker.selected&&document.body.contains(colorPicker.canvas)){colorPicker.selected=false;colorPicker.changed=true;}
